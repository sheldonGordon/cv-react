                    ...
                    <Form layout='vertical' onFinish={this.handleSubmit} >
                        ...
                        <div style={this.state.current !== 1 ? {display: 'none'} : {}}>
                            ...
                            <Form.Item label='Date de naissance'>
                                <DatePicker onChange={this.onChangeDate} showToday={false} format={dateFormat}
                                    placeholder='Sélectionner votre date de naissance' style={{width:'100%'}}/>
                            </Form.Item>
                        </div>
                        ...
                        <Form.Item wrapperCol={{offset:0}} layout='vertical' noStyle={this.state.current !== 7}>
                            <Button type='primary' htmlType='submit' style={this.state.current !== 7 ? {display: 'none'} : {}} >Enregistrer</Button>
                        </Form.Item>
                    </Form>
                </Col>
            </Row>
